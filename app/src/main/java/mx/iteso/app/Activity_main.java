            ...
            switch (position) {
                case 0:
                    if(fragmentTechnology == null){
                        return fragmentTechnology = new FragmentTechnology();
                    }
                    return fragmentTechnology;
                case 1:
                    if(fragmentHome == null){
                        return fragmentHome = new FragmentHome();
                    }
                    return fragmentHome;
                case 2:
                    if(fragmentElectronics == null){
                        return fragmentElectronics = new FragmentElectronics();
                    }
        ...
        switch (requestCode ){
            case 7189:
                if(resultCode == Activity.RESULT_OK){
                    ...
                    if(product != null){
                        fragmentTechnology.updateProduct(product);
                    }
